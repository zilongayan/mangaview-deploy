   ...
   */ async prepare() {
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && (0, _checks.isAppPageRouteModule)(routeModule);
        ...
        const doRender = async ({ postponed, pagesFallback = false, fallbackRouteParams })=>{
            ...
            let result;
            if (routeModule) {
                if ((0, _checks.isAppRouteRouteModule)(routeModule) || (0, _checks.isPagesRouteModule)(routeModule) || (0, _checks.isAppPageRouteModule)(routeModule)) {
                    // An OPTIONS request to a page handler is invalid.
                    if (req.method === 'OPTIONS' && !is404Page && !(0, _checks.isAppRouteRouteModule)(routeModule)) {
        ...
        components.ComponentMod.handler && ((0, _checks.isPagesRouteModule)(components.routeModule) || (0, _checks.isAppRouteRouteModule)(components.routeModule) || (0, _checks.isAppPageRouteModule)(components.routeModule))) {
        ...
        if (!cacheEntry) {
            if (ssgCacheKey && !(isOnDemandRevalidate && revalidateOnlyGenerated) && !(0, _checks.isPagesRouteModule)(components.routeModule) && !(0, _checks.isAppRouteRouteModule)(components.routeModule) && !(0, _checks.isAppPageRouteModule)(components.routeModule)) {
        ...
        if (!cachedData) {
            ...
            if (!this.minimalMode && cachedData.status && _redirectstatuscode.RedirectStatusCode[cachedData.status] && isRSCRequest) {
                res.statusCode = 200;
            }
